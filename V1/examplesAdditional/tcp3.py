...
##Property is: "Each connection should start with S. Atmost 4 consecutive S actions are allowed."##
######### (actions, states, initial state, final states, transition function)##
...
#
###############################################################################
###Define DFA describing property to enforcer phi2 ##############################
##Property is: "Data transfer "A" can occur only after at least one "SA".##
######### (actions, states, initial state, final states, transition function)##
###Set of actions Sigma = {'S', 'SA', 'A', 'F1', 'F2', 'R', 'Ot'}.##############
###############################################################################
phi2 = Automata.DFA(
...
#
###############################################################################
###Define DFA describing property to enforcer phi3 ##############################
##Property is: "Request to open a connection "S" is forbidden after "A" (i.e., after the connection is already establiehed). ##
######### (actions, states, initial state, final states, transition function)##
###Set of actions Sigma = {'S', 'SA', 'A', 'F1', 'F2', 'R', 'Ot'}.##############
###############################################################################
phi3 = Automata.DFA(
